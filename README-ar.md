...
Laradock هي بيئة تطوير PHP كاملة مخصصة لـ Docker. توفّر حاويات جاهزة للاستخدام ومُعدّة مسبقًا لكل ما يحتاجه تطبيق PHP (Nginx، وPHP-FPM، وMySQL، وPostgreSQL، وRedis، والمزيد)، لتتمكن من تشغيل بيئة عمل محلية كاملة خلال ثوانٍ بدون أي إعداد يدوي.
