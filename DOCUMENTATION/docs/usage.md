...
:::tip[The golden rule]
whenever you change the `.env` file, a service's `compose.yml` or `defaults.env`, or any `Dockerfile`, rebuild the affected container for the change to take effect:
