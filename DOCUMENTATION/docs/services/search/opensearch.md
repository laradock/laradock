...
title: OpenSearch
description: Run OpenSearch in Laradock, the Apache-2.0 fork of Elasticsearch. Start the container, configure the port, check cluster health, back up data, and connect from your app.
keywords:
  - laradock opensearch
  - opensearch docker
