...
title: Elasticsearch
description: Run Elasticsearch in Laradock. Start the container, check cluster health, back up and restore indices, install plugins, and connect from your PHP app or from Kibana/Dejavu.
keywords:
