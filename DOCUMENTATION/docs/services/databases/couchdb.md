...
title: CouchDB
description: Run Apache CouchDB in Laradock. Start and stop the container, configure the port, back up and restore data, and access Fauxton or the HTTP API.
keywords:
  - laradock couchdb
  - couchdb docker
