...
description: Run Percona Server in Laradock. Start and stop the container, configure port/credentials, create multiple databases, back up and restore, and connect from your host.
keywords:
  - laradock percona
