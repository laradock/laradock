...
title: SurrealDB
description: Run SurrealDB in Laradock. Start and stop the container, configure credentials and port, run SurrealQL queries, back up and restore data, and fix common issues.
keywords:
  - laradock surrealdb
  - surrealdb docker
