...
title: ClickHouse
description: Run ClickHouse in Laradock. Start and stop the container, configure ports and credentials, connect over HTTP or the native client, back up and restore data, and fix common issues.
keywords:
  - laradock clickhouse
  - clickhouse docker
