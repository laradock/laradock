...
slug: /services/mcp
title: MCP
description: Run an MCP server in Laradock, giving Claude, Cursor, and other AI coding agents read-only access to your database schema and data.
keywords:
  - laradock mcp
  - mcp server docker
  - mcp docker compose
  - model context protocol database
  - claude code mcp mysql
  - cursor mcp postgres
  - dbhub
---
...
Want a local LLM to go with it? See **[Ollama](/docs/services/ollama)**. Building AI features on your data? Pair it with a vector database like **[pgvector](/docs/services/pgvector)** or **[Qdrant](/docs/services/qdrant)**. New to Laradock? Start with **[Getting Started](/docs/getting-started)**.
