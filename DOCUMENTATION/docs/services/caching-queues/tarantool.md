...
title: Tarantool
description: Run Tarantool in Laradock. Start and stop the container, configure the port, use the interactive console, back up and restore data, and pair it with the Tarantool admin web UI.
keywords:
  - laradock tarantool
  - tarantool docker
