---
slug: /roundcube-on-docker
title: Run Roundcube on Docker
description: Run Roundcube webmail on Docker in minutes with Laradock. What Docker gives a Roundcube instance, why Laradock is the fastest way to get NGINX, PHP and MySQL running, and the exact commands, with any PHP version, without installing anything on your machine.
keywords:
  - roundcube on docker
  ...
  - dockerize roundcube
  - roundcube docker environment
  - roundcube nginx mysql docker
---
...
Prefer PostgreSQL instead? Swap the name: `./laradock start nginx postgres workspace`. The full catalog is [here](/docs/Intro#supported-services).
