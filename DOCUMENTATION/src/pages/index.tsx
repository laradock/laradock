...
const BENEFITS: { icon: string; title: string; text: string }[] = [
  ...
  { icon: "layers", title: "100+ Ready-made Services", text: "Databases, caches, queues, search engines, and more, pre-configured and waiting." },
  ...
  { icon: "cloud", title: "One Environment Everywhere", text: "Identical setup on Linux, macOS, and Windows, so your team shares the stack." },
  ...
  { icon: "rocket", title: "Deploy to Production", text: "Turn your stack into a hardened image with ./laradock ship, then deploy anywhere." },
];
