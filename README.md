...
The CLI is optional, transparent sugar: it prints every `docker compose` command it runs, keeps no state, and writes nothing but your `.env`. Unknown commands pass straight through (`./laradock logs -f nginx` = `docker compose logs -f nginx`). Full reference: [CLI docs](https://laradock.io/docs/cli).
...
Not using a framework? [Plain PHP works too](https://laradock.io/docs/getting-started).
...
> Built from two base images, each in its own repo: [`laradock/workspace`](https://github.com/laradock/workspace) (this dev shell) and [`laradock/php-fpm`](https://github.com/laradock/php-fpm) (the PHP runtime).
...
Four things no other tool combines: you **pick the services you want** and they come wired together, no setup of your own, with a **[`workspace`](https://laradock.io/docs/services/workspace) shell** that already has every PHP tool in it; **[`./laradock ship`](https://laradock.io/docs/production)** carries this exact environment to production; a **local AI stack** ([Ollama](https://laradock.io/docs/services/ollama), [LiteLLM](https://laradock.io/docs/services/litellm), [Qdrant](https://laradock.io/docs/services/qdrant)) is one command away; and an **AI agent can set it up for you** ([`AGENTS.md`](https://github.com/laradock/laradock/blob/master/AGENTS.md) + [`llms.txt`](https://laradock.io/llms.txt), just say *"Set up Laradock for this project"*). Full breakdown: **[Laradock vs Others](https://laradock.io/docs/laradock-alternatives)**, or head straight to [Sail](https://laradock.io/docs/laradock-vs-laravel-sail), [DDEV](https://laradock.io/docs/laradock-vs-ddev), [Herd](https://laradock.io/docs/laradock-vs-laravel-herd), [Lando](https://laradock.io/docs/laradock-vs-lando), [XAMPP](https://laradock.io/docs/laradock-vs-xampp), [Valet](https://laradock.io/docs/laradock-vs-valet), or [Homestead](https://laradock.io/docs/laradock-vs-homestead).
