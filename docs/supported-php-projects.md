...
Source: https://laradock.io/docs/supported-php-projects
...
If it's PHP, it works, even if there's no dedicated guide yet. Start from the [Getting Started guide](https://laradock.io/docs/getting-started), set your document root, and enable a database. The framework and CMS guides below are shortcuts, not requirements.
