...
Source: https://laradock.io/docs/frontaccounting-on-docker
...
The full catalog of services, if you later need a mail catcher for outgoing invoices or anything else, is [here](https://laradock.io/docs/Intro#supported-services).
