...
Source: https://laradock.io/docs/workerman-on-docker
...
The full catalog is [here](https://laradock.io/docs/Intro#supported-services). Add a database only if the app you build on Workerman uses one (see below).
