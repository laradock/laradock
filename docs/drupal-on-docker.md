...
Source: https://laradock.io/docs/drupal-on-docker
...
Comparing environments? See **[Laradock vs Drupal Docker](https://laradock.io/docs/laradock-vs-drupal-docker)** (DDEV & the official image) and the full **[Laradock vs Others](https://laradock.io/docs/laradock-alternatives)** breakdown. Ready to start? **[Getting Started](https://laradock.io/docs/getting-started)** takes about five minutes.
