...
Source: https://laradock.io/docs/azuracast-on-docker
...
Comparing environments? See the full **[Laradock vs Others](https://laradock.io/docs/laradock-alternatives)** breakdown. Looking for a PHP project that does fit Laradock's pattern? **[Getting Started](https://laradock.io/docs/getting-started)** takes about five minutes.
