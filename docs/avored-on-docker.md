...
Source: https://laradock.io/docs/avored-on-docker
...
Prefer MariaDB over MySQL? Swap the name: `./laradock start nginx mariadb redis workspace`. The full catalog is [here](https://laradock.io/docs/Intro#supported-services).
