...
- 🧠 **A one-click local AI stack.** `./laradock start ollama` runs a local LLM; vector databases ([Qdrant](https://laradock.io/docs/services/qdrant), [Weaviate](https://laradock.io/docs/services/weaviate), [Chroma](https://laradock.io/docs/services/chroma), [pgvector](https://laradock.io/docs/services/pgvector)), a model gateway ([LiteLLM](https://laradock.io/docs/services/litellm)), and agent automation ([n8n](https://laradock.io/docs/services/n8n), [Flowise](https://laradock.io/docs/services/flowise)) are one command each. Build AI features on your own machine with no cloud bills. No competitor bundles these.
...
- 🚀 **It follows you to production.** [`./laradock ship`](https://laradock.io/docs/production) builds one hardened image that runs on a server, Kamal, Kubernetes, or any managed cloud. The dev-only tools (Sail, Herd, Valet, XAMPP) stop at your laptop.
...
*Full breakdown with the same app set up in both tools: [Laradock vs DDEV](https://laradock.io/docs/laradock-vs-ddev).*
...
*Full breakdown with real commands for both: [Laradock vs Laravel Sail](https://laradock.io/docs/laradock-vs-laravel-sail).*
...
*Full breakdown: [Laradock vs Laravel Herd](https://laradock.io/docs/laradock-vs-laravel-herd).*
...
*Full breakdown with a migration guide: [Laradock vs Lando](https://laradock.io/docs/laradock-vs-lando).*
...
*Full breakdown with a 10-minute migration guide: [Laradock vs XAMPP / MAMP](https://laradock.io/docs/laradock-vs-xampp).*
...
*Full breakdown with a migration guide: [Laradock vs Laragon](https://laradock.io/docs/laradock-vs-laragon).*
...
*Full breakdown with a migration guide: [Laradock vs Laravel Valet](https://laradock.io/docs/laradock-vs-valet).*
...
*Full breakdown with a migration guide: [Laradock vs Local WP](https://laradock.io/docs/laradock-vs-local-wp).*
...
*Full breakdown: [Laradock vs Installing PHP Manually](https://laradock.io/docs/laradock-vs-manual-install).*
...
*Full breakdown with a migration guide: [Laradock vs Homestead / Vagrant](https://laradock.io/docs/laradock-vs-homestead).*
...
*Full breakdown including the combo setup: [Laradock vs Dev Containers](https://laradock.io/docs/laradock-vs-devcontainers).*
...
*Full breakdown: [Laradock vs Plain Docker Compose](https://laradock.io/docs/laradock-vs-docker-compose).*
