...
Source: https://laradock.io/docs/smf-on-docker
...
When your forum is ready, the same Laradock stack becomes your deployment. You build one hardened image and ship it to the host of your choice:
