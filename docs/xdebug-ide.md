...
Source: https://laradock.io/docs/xdebug-ide

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

Installing Xdebug in the container is the container's job, see [Install Xdebug](https://laradock.io/docs/services/php-fpm#install-xdebug) on the PHP-FPM page for the `.env` flags and rebuild. This page is the other half: pointing your editor at it so breakpoints actually stop.
...
Stop it again with `./php-fpm/xdebug stop`. See [Start or stop Xdebug](https://laradock.io/docs/services/php-fpm#start-or-stop-xdebug) for details.
