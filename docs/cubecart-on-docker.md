...
Source: https://laradock.io/docs/cubecart-on-docker
...
Prefer MariaDB over MySQL? Swap the name: `./laradock start nginx mariadb workspace`. The full catalog is [here](https://laradock.io/docs/Intro#supported-services).
