...
Source: https://laradock.io/docs/fluxbb-on-docker
...
When your FluxBB forum is ready, the same Laradock stack becomes your deployment. You build one hardened image and ship it to the host of your choice:
