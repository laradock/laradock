...
Source: https://laradock.io/docs/multiple-projects
...
Need those projects (or one project's microservices) on **different PHP versions at the same time**? See [Multiple PHP Versions](https://laradock.io/docs/multiple-php-versions).
