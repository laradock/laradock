...
Source: https://laradock.io/docs/volumes
...
See [Running multiple projects](https://laradock.io/docs/getting-started#running-multiple-projects) for the full setup.
