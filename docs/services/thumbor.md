...
Source: https://laradock.io/docs/services/thumbor
...
Need S3-compatible storage to serve source images from? See **[MinIO](https://laradock.io/docs/services/minio)**. New to Laradock? Start at **[Getting Started](https://laradock.io/docs/getting-started)**.
