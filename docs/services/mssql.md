...
Source: https://laradock.io/docs/services/mssql
...
Need a MySQL-compatible database instead? See **[MySQL](https://laradock.io/docs/services/mysql)**. For the full list of services, see **[Getting Started](https://laradock.io/docs/getting-started)**.
