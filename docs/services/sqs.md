...
Source: https://laradock.io/docs/services/sqs
...
Need a general-purpose queue instead? See **[RabbitMQ](https://laradock.io/docs/services/rabbitmq)** or **[Beanstalkd](https://laradock.io/docs/services/beanstalkd)**. New to Laradock? Start at **[Getting Started](https://laradock.io/docs/getting-started)**.
