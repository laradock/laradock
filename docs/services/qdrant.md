...
Source: https://laradock.io/docs/services/qdrant
...
Comparing vector databases? See **[Weaviate](https://laradock.io/docs/services/weaviate)** and **[Chroma](https://laradock.io/docs/services/chroma)**. New to Laradock? Start with **[Getting Started](https://laradock.io/docs/getting-started)**.
