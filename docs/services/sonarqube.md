...
Source: https://laradock.io/docs/services/sonarqube
...
Need CI to run SonarQube scans automatically? See **[Jenkins](https://laradock.io/docs/services/jenkins)** or **[GitLab Runner](https://laradock.io/docs/services/gitlab-runner)**. New to Laradock? Start at **[Getting Started](https://laradock.io/docs/getting-started)**.
