...
Source: https://laradock.io/docs/services/redis-webui
...
Prefer the command line? See **[Redis](https://laradock.io/docs/services/redis)** for `redis-cli` usage. New to Laradock? Start at **[Getting Started](https://laradock.io/docs/getting-started)**.
