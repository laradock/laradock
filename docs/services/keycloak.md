...
Source: https://laradock.io/docs/services/keycloak
...
Need a general-purpose Postgres database instead? See the **[Databases guide](https://laradock.io/docs/Intro#supported-services)**. New to Laradock? Start at **[Getting Started](https://laradock.io/docs/getting-started)**.
