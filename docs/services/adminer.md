...
Source: https://laradock.io/docs/services/adminer
...
Prefer a MySQL-focused GUI instead? See **[phpMyAdmin](https://laradock.io/docs/services/phpmyadmin)**. Back to the **[Getting Started guide](https://laradock.io/docs/getting-started)**.
