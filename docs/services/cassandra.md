...
Source: https://laradock.io/docs/services/cassandra
...
Need a document database instead? See **[CouchDB](https://laradock.io/docs/services/couchdb)**. For the full list of services, see **[Getting Started](https://laradock.io/docs/getting-started)**.
