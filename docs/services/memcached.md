...
Source: https://laradock.io/docs/services/memcached
...
Need persistence or richer data structures? See **[Redis](https://laradock.io/docs/services/redis)**. New to Laradock? Start at **[Getting Started](https://laradock.io/docs/getting-started)**.
