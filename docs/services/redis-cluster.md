...
Source: https://laradock.io/docs/services/redis-cluster
...
Just need a single Redis instance? See **[Redis](https://laradock.io/docs/services/redis)**. New to Laradock? Start at **[Getting Started](https://laradock.io/docs/getting-started)**.
