...
Source: https://laradock.io/docs/services/mongo-webui
...
Need the database itself, not just the UI? See **[MongoDB](https://laradock.io/docs/services/mongo)**. For the full list of services, see **[Getting Started](https://laradock.io/docs/getting-started)**.
