...
Source: https://laradock.io/docs/services/metabase
...
Need the database Metabase is reporting on? See the **[Databases guide](https://laradock.io/docs/Intro#supported-services)**. New to Laradock? Start at **[Getting Started](https://laradock.io/docs/getting-started)**.
