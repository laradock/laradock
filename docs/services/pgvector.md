...
Source: https://laradock.io/docs/services/pgvector
...
Need plain Postgres without vectors? See the **[PostgreSQL](https://laradock.io/docs/services/postgres)** page. Back to the **[Databases guide](https://laradock.io/docs/Intro#supported-services)**.
