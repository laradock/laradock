...
Source: https://laradock.io/docs/services/manticore
...
Need OLAP analytics instead? See **[ClickHouse](https://laradock.io/docs/services/clickhouse)**. Back to the **[Getting Started guide](https://laradock.io/docs/getting-started)**.
