...
Source: https://laradock.io/docs/services/mailcatcher
...
If you need captured mail to survive container restarts across a longer test run, that's a reason to reach for **[Mailpit](https://laradock.io/docs/services/mailpit)** instead, which persists to a database file on disk.
...
- **Looking for something more actively developed.** MailCatcher (the Ruby gem) sees infrequent updates. **[Mailpit](https://laradock.io/docs/services/mailpit)** is a modern, actively maintained alternative with the same core idea.

---

Prefer the actively maintained, Go-based alternative? See **[Mailpit](https://laradock.io/docs/services/mailpit)**. New to Laradock? Start with **[Getting Started](https://laradock.io/docs/getting-started)**.
