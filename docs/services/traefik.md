...
Source: https://laradock.io/docs/services/traefik
...
Prefer a simpler reverse proxy with built-in HTTPS? See **[Caddy](https://laradock.io/docs/services/caddy)**. New to Laradock? Start with **[Getting Started](https://laradock.io/docs/getting-started)**.
