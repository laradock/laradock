...
Source: https://laradock.io/docs/services/openresty
...
- **Not sure whether to reach for Lua or plain server-block config.** If you don't need scripted request handling, the vanilla **[Nginx](https://laradock.io/docs/services/nginx)** service uses the same site config format and is a lighter-weight choice.
...
Need a different web server? See **[Nginx](https://laradock.io/docs/services/nginx)**, **[Apache](https://laradock.io/docs/services/apache2)**, or **[Caddy](https://laradock.io/docs/services/caddy)**. New to Laradock? Start with **[Getting Started](https://laradock.io/docs/getting-started)**.
