...
Source: https://laradock.io/docs/services/docker-registry
...
Need to build and run Docker-in-Docker for CI-style workflows? See **[Docker in Docker](https://laradock.io/docs/services/docker-in-docker)**. New to Laradock? Start at **[Getting Started](https://laradock.io/docs/getting-started)**.
