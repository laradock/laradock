...
Source: https://laradock.io/docs/services/n8n
...
Want a lower-code way to prototype LLM/agent flows instead? See **[Flowise](https://laradock.io/docs/services/flowise)**. New to Laradock? Start with **[Getting Started](https://laradock.io/docs/getting-started)**.
