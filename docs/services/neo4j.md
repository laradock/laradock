...
Source: https://laradock.io/docs/services/neo4j
...
Need a wide-column store instead? See **[Cassandra](https://laradock.io/docs/services/cassandra)**. For the full list of services, see **[Getting Started](https://laradock.io/docs/getting-started)**.
