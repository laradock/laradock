...
Source: https://laradock.io/docs/services/mailu
...
Just need to catch dev email, not run a real mail server? See **[Mailpit](https://laradock.io/docs/services/mailpit)**. New to Laradock? Start with **[Getting Started](https://laradock.io/docs/getting-started)**.
