...
Source: https://laradock.io/docs/services/confluence
...
2. Configure SSL keys for your domain (see the [NGINX guide](https://laradock.io/docs/services/nginx) for certificate setup).
...
Fronting it with a domain and TLS? See the **[NGINX guide](https://laradock.io/docs/services/nginx)**. New to Laradock? Start at **[Getting Started](https://laradock.io/docs/getting-started)**.
