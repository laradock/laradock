...
Source: https://laradock.io/docs/services/typesense
...
Prefer a search engine with a broader plugin ecosystem? See **[Elasticsearch](https://laradock.io/docs/services/elasticsearch)** or **[MeiliSearch](https://laradock.io/docs/services/meilisearch)**. New to Laradock? Start with **[Getting Started](https://laradock.io/docs/getting-started)**.
