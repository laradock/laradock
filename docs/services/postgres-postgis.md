...
Source: https://laradock.io/docs/services/postgres-postgis
...
Need Postgres without the geospatial extension? See **[PostgreSQL](https://laradock.io/docs/services/postgres)**. For the full list of services, see **[Getting Started](https://laradock.io/docs/getting-started)**.
