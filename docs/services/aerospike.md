...
Source: https://laradock.io/docs/services/aerospike
...
- **PHP calls fail with "class Aerospike not found."** The PHP extension isn't installed yet, it's not bundled by default. Follow **[Install the Aerospike extension](https://laradock.io/docs/services/php-fpm#install-the-aerospike-extension)** and rebuild `workspace`/`php-fpm`.
