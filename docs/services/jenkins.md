...
Source: https://laradock.io/docs/services/jenkins
...
Need a full CI/CD pipeline with its own Git server instead? See **[GitLab](https://laradock.io/docs/services/gitlab)** or **[OneDev](https://laradock.io/docs/services/onedev)**. New to Laradock? Start at **[Getting Started](https://laradock.io/docs/getting-started)**.
