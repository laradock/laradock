...
Source: https://laradock.io/docs/services/nats
...
Need a message queue with a management UI instead? See **[RabbitMQ](https://laradock.io/docs/services/rabbitmq)**. New to Laradock? Start at **[Getting Started](https://laradock.io/docs/getting-started)**.
