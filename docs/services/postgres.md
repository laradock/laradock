...
Source: https://laradock.io/docs/services/postgres
...
- **Need PostGIS instead.** This plain `postgres` service has no geospatial extension; use **[postgres-postgis](https://laradock.io/docs/services/postgres-postgis)** if your app needs it.

---

Need automated backups? See **[pgbackups](https://laradock.io/docs/services/pgbackups)**. Prefer a GUI? See pgAdmin in the **[Databases guide](https://laradock.io/docs/Intro#supported-services)**.
