...
Source: https://laradock.io/docs/services/mariadb
...
Need the original MySQL instead? See **[MySQL](https://laradock.io/docs/services/mysql)**. For the full list of services, see **[Getting Started](https://laradock.io/docs/getting-started)**.
